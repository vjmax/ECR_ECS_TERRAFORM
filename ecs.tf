...
resource "aws_ecs_task_definition" "demo_ecs_app_def1" {

  family                   = var.aws_ecs_task_def_fam1
...
resource "aws_ecs_service" "main" {
  ...
  task_definition = aws_ecs_task_definition.demo_ecs_app_def1.arn
  ...
  depends_on = [
    ...
    aws_ecs_task_definition.demo_ecs_app_def1,
    module.vpc
  ]
